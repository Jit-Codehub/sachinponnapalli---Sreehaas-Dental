...
class HomePageView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        self.extra_context["services"] = Service.objects.all().values("name","slug","image","image_caption")[:6]
        self.extra_context["testimonial"] = home.testimonial_set.all()
        self.extra_context["home"] = home
        doctors = Doctor.objects.prefetch_related('social_links').all()
...
class DoctorPageView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        doctor_obj = get_object_or_404(Doctor,slug=doctor_slug)
...
def services(requests,service_name):
    ...
    service_obj = get_object_or_404(Service,slug=service_name)
